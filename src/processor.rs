...
impl Processor {
    ...
    fn process_send_mail(
        ...
        // let mut sender_data = MailAccount::try_from_slice(&sender_account.data.borrow()[..])?;
        // sender_data.sent.push(mail.clone());
        // sender_data.serialize(&mut &mut sender_account.data.borrow_mut()[..]);

        // let mut receiver_data = MailAccount::try_from_slice(&receiver_account.data.borrow()[..])?;
        // receiver_data.inbox.push(mail.clone());
